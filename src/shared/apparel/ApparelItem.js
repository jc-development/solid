...
// import './assets/css/apparel-item.css';
  ...
  render() {
    ...
    return (
      <div className="apparel">
        {this.props.match.params.apparelItem === "solid-performance-tee" ?
          <article>
            <header>
        ...
        :
        this.props.match.params.apparelItem === "solid-hoodie" ?
          <article>
            <header>
              <h1>Solid Hoodie</h1>
            </header>
        ...
        :
          <h1>We could not locate the page you were looking for...standby for redirect to apparel</h1>
        }
...
export default connect(mapStateToProps, {fetchAddStoreCheckout: fetchAddStoreCheckoutAction})(ApparelItem);
