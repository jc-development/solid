...
class Accessory extends Component {
  ...
  componentWillMount() {
    if (this.props.match.params.accessory === "leather-strop" || this.props.match.params.accessory === "armory-case") {
  ...
  render() {
    return (
      <div className="accessory">
        {this.props.match.params.accessory === "leather-strop" ?
          <article>
            <header>
              <h1>Leather Strop</h1>
            </header>
        ...
        :
          this.props.match.params.accessory === "armory-case" ?
            <article>
              <header>
                <h1>Solid Armory</h1>
              </header>
          ...
          :
            <h1>We could not locate the page you were looking for...standby for redirect to accessories</h1>
        }
